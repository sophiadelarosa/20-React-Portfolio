        ...
        <div>
            ...
            <div class="row">
                <div class="leftcolumn">
                    <img id="project3" height="550px" width="275px" />
                </div>
                <div class="rightcolumn">
                    ...
                    <a href="https://github.com/hackpres/DnDevs_React" target="_blank"><p> See the repository </p></a>
                </div>
            </div>

            <a href="https://www.dropbox.com/s/abnflpti6d2emjg/19-PWA-text-editor.mp4?dl=0" target="_blank"><h2> Progressive Web Applications: Text Editor </h2></a>
            <div class="row">
                <div class="leftcolumn">
            ...
            <a href="https://dn-devs-react.vercel.app" target="_blank"><h2> Dungeons & Devs </h2></a>
            <div class="row">
                <div class="leftcolumn">
                ...
                <div class="rightcolumn">
                    ...
                    <a href="https://github.com/wtguenthner/Dungeons-Devs" target="_blank"><p> See the repository </p></a>
                </div>
            </div>
            ...
            <a href="https://github.com/sophiadelarosa/ORM-E-Commerce-Back-End" target="_blank"><p> See the repository </p></a>
            ...
            <div class="row">
                ...
                <div class="right column">
                    ...
                    <a href="https://github.com/sophiadelarosa/Express.js-Note-Taker" target="_blank"><p> See the repository </p></a>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="rightcolumn">
                    ...
                    <a href="https://github.com/sophiadelarosa/Node.js-CLI-Team-Profile-Generator" target="_blank"><p> See the repository </p></a>
                </div>
            </div>
            
            <a href="https://sophiadelarosa.github.io/Music-Discovery-App/" target="_blank"><h2> Music Discovery App </h2></a>
            <div class="row">
                <div class="leftcolumn">
                ...
                <div class="rightcolumn">
                    ...
                    <a href="https://github.com/sophiadelarosa/Music-Discovery-App" target="_blank"><p> See the repository </p></a>
                </div>
            </div>

            <a href="https://sophiadelarosa.github.io/Moment.js-Workday-Scheduler/" target="_blank"><h2> Day Planner using third-party APIs </h2></a>
            <div class="row">
                <div class="leftcolumn">
                ...
                <div class="rightcolumn">
                    ...
                    <a href="https://github.com/sophiadelarosa/Moment.js-Workday-Scheduler" target="_blank"><p> See the repository </p></a>
                </div>
            </div>
            

            <a href="https://sophiadelarosa.github.io/Web-API-Code-Quiz/" target="_blank"><h2> Web API Code Quiz </h2></a>
            <div class="row">
                <div class="leftcolumn">
                ...
                <div class="rightcolumn">
                    <p> This is a single page text editor application that runs in the browser and meets the PWA criteria. It features data persistence techniques that serve as redundancy in case one of the options is not supported by the browser. The application also functions offline.</p>
                    <a href="https://github.com/sophiadelarosa/Web-API-Code-Quiz" target="_blank"><p> See the repository </p></a>
                </div>
            </div>
            

            <a href="https://sophiadelarosa.github.io/Password-Generator/" target="blank"><h2> JavaScript Password Generator </h2></a>
            <div class="row">
                <div class="leftcolumn">
                ...
                <div class="rightcolumn">
                    ...
                    <a href="https://github.com/sophiadelarosa/Password-Generator" target="_blank"><p> See the repository </p></a>
                </div>
            </div>
